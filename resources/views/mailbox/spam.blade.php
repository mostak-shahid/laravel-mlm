            ...
            <div class="col-sm-9 mail_view">
                <div class="inbox-body">
                    <form action="{{route('user.mailbox.mailmanagement')}}" method="POST">
                        ...
                        <tr>
                            <th></th>
                            <th class="align-middle" width="60px">
                            ...
                            <th>
                                <div class="mail-select-options">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <button class="btn btn-default" type="submit" name="mailmanagement" value="Not spam" data-placement="top" data-toggle="tooltip" data-original-title="Not spam"><i class="fa fa-exclamation-circle"></i></button>
